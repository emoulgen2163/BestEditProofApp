        ...
        Card(
            ...
            Column(Modifier.padding(16.dp)) {
                ...
                Column(
                    ...
                    ButtonComp(text = "Register", color = BorderFocused, onButtonClick = { })
                    Spacer(Modifier.height(8.dp))
                    ButtonComp(text = "Register with Facebook", color = FacebookBlue, onButtonClick = { })
                    Spacer(Modifier.height(8.dp))
                    ButtonComp(text = "Register with Google", color = GoogleRed, onButtonClick = { })
                }
            }
        }
